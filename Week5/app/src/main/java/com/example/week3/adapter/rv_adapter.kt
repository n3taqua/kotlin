...
class rv_adapter( var layoutMananger:GridLayoutManager) :RecyclerView.Adapter<rv_adapter.MovieViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        Glide.with(holder.img_film_poster).load("https://image.tmdb.org/t/p/w500/"+listMovie[position].poster_path).into(holder.img_film_poster)
